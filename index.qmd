...
```{r}
# Black and White Box summer holiday dates
tbawb_holiday_dates_this_year <- get_summer_holiday_dates(lubridate::year(current_date), december_start_day = 28, january_end_day = 5)
tbawb_holiday_dates_next_year <- get_summer_holiday_dates(lubridate::year(current_date) + 1, december_start_day = 28, january_end_day = 5)
tbawb_holiday_dates <- c(tbawb_holiday_dates_this_year, tbawb_holiday_dates_next_year)
```

```{r}
full_holiday_dates <- c(holiday_dates_df$ObservedDate, tbawb_holiday_dates)
```
